        ...
        if (interaction.member.roles.cache.has(doc.data().id) === true) {
          ...
          if (offenderMember.moderatable === true) {
            ...
            embed.setDescription(
              `The server warn has been issued to <@${offender.id}> (${offender.id}) and has been successfully logged.`
            );
            ...
            offender.send({ embeds: [embedtoSend] }).catch((error) => {
              setTimeout(() => {
                ...
                embed.setDescription(
                  `I was unable to DM the user due to their privacy settings, although they've still been warned.`
                );
                embed.setColor("Red");
            ...
            embed.setDescription(
              `<@${offender.id}> (${offender.id}) has been warned.`
            );
            embed.addFields(
              { name: "Reason", value: `${reason}`, inline: true },
              { name: "Case ID", value: `${caseId}`, inline: true },
            ...
            embed.setDescription(
              "I was unable to warn this member, please ensure my role is higher than the offender and be sure you're not trying to warn the server owner."
            );
            embed.setColor("Red");
