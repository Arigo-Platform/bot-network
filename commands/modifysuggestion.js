        ...
        if (interaction.member.roles.cache.has(doc.data().id) === true) {
          ...
          if (result.exists) {
            ...
            const cityReff = db
              ...
              .doc(`${serverId}`)
              .collection("settings")
              .doc("suggestionChannel");
            const channelid = await cityReff.get();
            let suggestionchannel = interaction.guild.channels.cache.get(
              channelid.data().id
            );
            // Get the author information:
            authorInfo = await interaction.guild.members.fetch(
              result.data().author
            );
            const msg = suggestionchannel.messages
              .fetch(result.data().msgId)
              .then(async (message) => {
                events.info("ModifySuggestion", {
                  user: `${userId}`,
                  type: "approve",
                ...
                const sLink = new ActionRowBuilder().addComponents(
                  new ButtonBuilder()
                    .setURL(
                ...
                todmembed.setDescription(
                  `Hello, <@${authorInfo.user.id}>! Your suggestion in ` +
                    "``" +
                ...
                authorInfo
                  .send({ embeds: [todmembed], components: [sLink] })
                  .catch((error) => {
                ...
                embed.setTitle(
                  `Suggestion from ${authorInfo.user.username} | Approved by ${interaction.user.username}`
                );
            ...
            embed.setDescription(
              "I was unable find a suggestion with the ID of ``" +
                suggestionId +
                "``."
            );
            embed.setColor("Red");
          ...
          if (result.exists) {
            ...
            const msg = suggestionchannel.messages
              ...
              .then(async (message) => {
                ...
                // Edit Suggestion Message:
                embed.setTitle(
                  `Suggestion from ${authorInfo.user.username} | Denied by ${interaction.user.username}`
                );
                embed.setDescription(result.data().suggestion);
                embed.addFields({
                  name: "Reason",
          ...
          if (result.exists) {
            ...
            const msg = suggestionchannel.messages
              ...
              .then(async (message) => {
                ...
                // Edit Suggestion Message:
                embed.setTitle(
                  `Suggestion from ${authorInfo.user.username} | Considered by ${interaction.user.username}`
                );
                embed.setDescription(result.data().suggestion);
                embed.addFields({
                  name: "Reason",
          ...
          if (result.exists) {
            ...
            const msg = suggestionchannel.messages
              ...
              .then(async (message) => {
                ...
                // Edit Suggestion Message:
                embed.setTitle(
                  `Suggestion from ${authorInfo.user.username} | Deleted by ${interaction.user.username}`
                );
