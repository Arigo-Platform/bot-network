      ...
      if (sid.exists) {
        ...
        docRef1.get().then((doc) => {
          if (doc.exists) {
            ...
            embed.setTitle(
              `New Suggestion from ${interaction.member.user.username}`
            );
        ...
        embed.setDescription(
          `Your suggestion has been posted to <#${
            sid.data().id
