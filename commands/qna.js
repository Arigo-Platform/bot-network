...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("qna")
    .setDescription(
      "Ask questions and get incredible answers. Powered by OpenAI."
    )
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        embed.setDescription(
          "I was either unable to find an answer to your question or there was an internal server erorr. Please report this to Arigo Customer Support if the problem persists."
        );
        embed.setColor("Red");
